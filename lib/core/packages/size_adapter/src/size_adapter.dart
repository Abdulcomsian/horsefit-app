import 'package:horse_fit/core/packages/size_adapter/src/extensions/context_ext.dart';
import 'package:horse_fit/core/packages/size_adapter/src/utils/size_adapter_config.dart';
        ...
        return OrientationBuilder(builder: (context, orientation) {
          ...
          return MediaQuery(
            data: MediaQuery.of(context)
                .copyWith(textScaler: TextScaler.linear(textScaleFactor ?? 1)),
            child: child,
          );
        });
      }),
