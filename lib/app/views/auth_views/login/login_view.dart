...
class _LoginViewState extends State<LoginView> {
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                children: [
                  ...
                  SvgPictureAssetWidget(ImagesResource.logoIcon, width: 560.w),
                      ...
                      return TextFormFieldWidget(
                        ...
                        suffixIcon: Padding(
                          ...
                          child: SvgPictureAssetWidget(
                            ...
                            .read<LoginBloc>()
                            .add(const LoginEvent.togglePasswordVisibility())),
                        prefixIconConstraints: const BoxConstraints(),
                        validator: (password) =>
  ...
  void _listener(LoginState state, BuildContext context) {
    ...
    ///! TODO Move user to feed view
    // if (status) context.pushNamed(RouteNames.feedView);
  }
}
